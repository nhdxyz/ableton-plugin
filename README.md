...
- Sequencer: internal 16-step piano-roll style pattern area with root-aware note rows, scale helper, chord/stab modes, voicing and strum controls, beat grouping, groove cues, rotate and variation utilities, MIDI export, and quick pattern tools for riffs, basslines, and generated ideas.
