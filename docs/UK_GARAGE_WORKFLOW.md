...
- The SEQ template selector now has first-pass house, tech-house, techno, and minimal pattern starters; later preset-pack work should turn those into full factory patch categories with the same repo-managed generator flow.
