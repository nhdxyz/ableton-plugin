...
- The SAMPLE recorder now exposes the actual 8-second rolling capture-buffer fill as a compact progress meter, with recording, ready-to-commit, loaded-sample, and full/rolling states visible in the main SAMPLE panel.
