...
- Sample Lab: load audio, view the waveform, jump and audition phrase slices with eight pads, drag chop windows with visible handles, reverse/pitch/gain/mix it, store per-slice pitch/gain/reverse/stutter/choke behavior, and trigger Slice Keys from MIDI C3-G3.
