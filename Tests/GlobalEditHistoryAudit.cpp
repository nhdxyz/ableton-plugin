...
int main()
{
    ...
    if (! setPlainParameter(processor, Parameters::ID::filterCutoff, 760.0f)
        ...
        || ! setPlainParameter(processor, Parameters::ID::modMatrixPolarity[0], 1.0f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixCurve[0], 1.0f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixRangeMin[0], -0.5f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixRangeMax[0], 1.0f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixSlew[0], 0.2f))
    {
    ...
    if (! setPlainParameter(processor, Parameters::ID::filterCutoff, 2460.0f)
        ...
        || ! setPlainParameter(processor, Parameters::ID::modMatrixPolarity[0], 3.0f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixCurve[0], 4.0f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixRangeMin[0], 0.0f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixRangeMax[0], 0.65f)
        || ! setPlainParameter(processor, Parameters::ID::modMatrixSlew[0], 0.48f))
    {
    ...
    if (! near(readPlainParameter(processor, Parameters::ID::filterCutoff, 0.0f), 760.0f)
        ...
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixPolarity[0], 0.0f), 1.0f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixCurve[0], 0.0f), 1.0f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixRangeMin[0], 0.0f), -0.5f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixRangeMax[0], 0.0f), 1.0f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixSlew[0], 0.0f), 0.2f)
        ...
        || ! processor.canRedoGlobalEdit())
    {
        std::cerr << "Global undo did not restore the initial synth/mod/sequencer state\n"
                  ...
                  << " modPolarity=" << readPlainParameter(processor, Parameters::ID::modMatrixPolarity[0], 0.0f)
                  << " modCurve=" << readPlainParameter(processor, Parameters::ID::modMatrixCurve[0], 0.0f)
                  << " modRangeMin=" << readPlainParameter(processor, Parameters::ID::modMatrixRangeMin[0], 0.0f)
                  << " modRangeMax=" << readPlainParameter(processor, Parameters::ID::modMatrixRangeMax[0], 0.0f)
                  << " modSlew=" << readPlainParameter(processor, Parameters::ID::modMatrixSlew[0], 0.0f)
    ...
    if (! near(readPlainParameter(processor, Parameters::ID::filterCutoff, 0.0f), 2460.0f)
        ...
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixPolarity[0], 0.0f), 3.0f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixCurve[0], 0.0f), 4.0f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixRangeMin[0], 0.0f), 0.0f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixRangeMax[0], 0.0f), 0.65f)
        || ! near(readPlainParameter(processor, Parameters::ID::modMatrixSlew[0], 0.0f), 0.48f)
