...
Implemented recorder note: the current 8-second SAMPLE recorder now has a rolling-buffer progress meter, `REC -> READY -> USE -> PLAY` state rail, and compact-host layout coverage; deeper input/source selection and drag/drop import remain open.
