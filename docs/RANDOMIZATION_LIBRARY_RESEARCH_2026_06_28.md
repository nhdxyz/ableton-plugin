...
- The repo-managed factory pack now covers 24 UKG, house, tech-house, minimal, and techno starter presets, with newer presets carrying curated `preset_notes` for the Library inspector.
