...
Current house/UKG workflow focus: HOME performance macros and club low-end guidance, SEQ chord/voicing/strum plus the new one-finger Memory toggle, waveform-based sample chopping with click guards, section-scoped randomization, and an addable FX rack with throw controls.
