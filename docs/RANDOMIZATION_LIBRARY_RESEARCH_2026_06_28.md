...
- LIBRARY now separates Find, Browser, Save Patch, and Inspect areas, shows selected-preset role, traits, cue, Tone/Dirt/Motion/Space profile, and macro shape in a dedicated adaptive summary component, and keeps HOME preset access to recall/audition instead of save metadata.
- The repo-managed factory pack now covers 72 UKG, speed-garage, bass-house, breakbeat-garage, house, Chicago-house, classic-house, funky-house, deep-tech, French-house, soulful-house, garage-house, breaks-house, tribal tech-house, melodic-house, piano-house, disco-house, Latin-house, organic-house, afro-house, lo-fi/Detroit/progressive-house, future-garage, electro-house, electro-breaks, tech-house, microhouse, Romanian-minimal, minimal, dub-techno, raw/hypnotic techno, hardgroove/warehouse-techno, melodic-techno, Amapiano-inspired, and techno starter presets, with newer presets carrying curated `preset_notes` for the Library inspector.
...
- HOME now includes stereo field/correlation visualization beside the spectrum display, exposing full-band width, balance, correlation, low-end side risk, held spectrum peaks, and grouped sub/low/mid/presence/air energy for mono-safe house and club mix decisions.
