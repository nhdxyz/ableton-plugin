...
- FX: post-synth/post-sample tone cleanup, three-band EQ, distortion, pump, tremolo/auto pan, ring modulation, phaser, flanger, chorus, delay, reverb, output trim, and Guard safety clipping.
