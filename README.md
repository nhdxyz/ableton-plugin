...
- Library: save, load, audition, compare/revert recent preset loads, search, sort, tag, favorite, rate, inspect, macro-value preview, preset notes, and metadata-label categorized `.natevstpreset` files from recursive user and factory preset folders, including House, Tech House, Techno, Minimal, UKG, pack, key, and tempo filters.
