...
- Library Save dropdowns now include the newer house/techno style folders and pack targets used by the 72-preset factory pack, including House/Acid, House/Keys, House/Plucks, Techno/Dub, Techno/Hardgroove, Romanian Minimal, Electro Breaks, House Chords, Dub Stabs, Minimal Plucks, Dub Techno Tools, and Electro Breaks Tools.
