...
The repo-managed factory pack currently includes 88 starter presets across UKG, speed garage, future garage, breakbeat garage, house, jackin house, bass house, Chicago house, classic house, funky house, acid house, indie dance, Italo disco, Balearic house, nu-disco, deep tech, afro tech, French house, soulful house, garage house, breaks house, tribal tech house, melodic house, afro melodic house, progressive house, hard house, amapiano-inspired log drum, piano house, disco house, Latin house, organic house, afro house, lo-fi house, Detroit house, Detroit techno, peak-time techno, electro house, electro breaks, tech-house, microhouse, Romanian minimal, deep minimal, minimal/FM, raw/hypnotic techno, hardgroove techno, dub techno, warehouse techno, melodic techno, and techno.
...
Current house/UKG workflow focus: cleaner oscillator sources, percussive noise ticks/air/vinyl/digital texture, internal wavetable movement, Osc Warp source motion, visible Filter Character/Slope/cutoff/resonance shaping for bass and stab color, HOME performance macros, output oscilloscope/spectrum/stereo/Club Monitor analysis with held spectrum peaks, grouped club-band balance, short-history sub/side/pump/Guard/peak risk, and club low-end guidance, redesigned preset recall/save/library flow, MOD destination inspection with per-route bypass/delete, SEQ chord/voicing/strum plus one-finger Memory, host-sync status, selective groove transforms, and the first assignable per-step lock lane for rhythmic cutoff/drive/warp/pump/delay/reverb/WT movement, waveform-based sample chopping with click guards, slice styles, Slice Keys, and per-slice region/pan/chance/choke memory, section-scoped randomization, and an addable FX rack with send-style throws, Guard glue/punch/clip dynamics, and module presets.
