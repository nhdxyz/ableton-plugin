...
- Synth engine: oscillator 1, oscillator 2, sub, noise, Osc Warp source shaping, unison/spread, envelopes, multimode filter, Filter Character and Slope modes, drive, editable modulation with per-route bypass/delete, LFO/Mod Env/Velocity/S&H/Smooth movement sources, and eight stable performance macros for club-ready tone, dirt, motion, space, weight, bounce, warp, and throw moves. Saw, square, and triangle sources include a first bandlimited quality pass for cleaner bright stabs and bass harmonics.
