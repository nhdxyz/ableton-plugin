...
void LowEndAssistant::paint(juce::Graphics& g)
{
    ...
    auto titleArea = content.removeFromLeft(38);
    g.setFont(juce::FontOptions(10.0f, juce::Font::bold));
    g.setColour(juce::Colour(0xff8ee6c9));
    g.drawFittedText("CLUB", titleArea, juce::Justification::centredLeft, 1);

    auto rootArea = content.removeFromLeft(72);
    g.setColour(juce::Colour(0xffdce7e4));
    g.drawFittedText(state.rootText, rootArea.removeFromTop(15), juce::Justification::centredLeft, 1);
    ...
    g.drawFittedText(monoText, rootArea, juce::Justification::centredLeft, 1);
...
{
    auto labelArea = area.removeFromTop(13);
    auto track = area.reduced(0, 2).toFloat();
