...
- Sequencer: internal 16-step piano-roll style pattern area with root-aware note rows, scale helper, beat grouping, groove cues, rotate utilities, MIDI export, and quick pattern tools for riffs, basslines, and generated ideas.
