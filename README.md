...
- Sound Lab: page-based guided randomization with focused Generate, Mutate, Recipe, History, and Save areas, recipe intent/tempo/use-case summaries, Vary/Mutate/Wild mutation strengths, one-click Source/Env/Filter/Sample/FX/Seq/Macro section rolls, four recallable/generated-cue candidate slots with compare summaries, changed-section diff badges, save-from-slot with favorite/rating handoff, and A/B snapshot promotion, recipes, section locks, undo/redo, generated preset draft naming, generated preset metadata, category/pack/BPM save suggestions, and safety rules.
