...
void layout(juce::Rectangle<int> content, Components components)
{
    ...
    components.primaryActions.setVisible(true);
    components.refreshButton.setVisible(true);
    components.compareActions.setVisible(true);
    ...
    components.primaryActions.setLayoutMode(PresetPrimaryActions::LayoutMode::library);
    components.primaryActions.setBounds(primaryActions.removeFromLeft(PresetPrimaryActions::preferredWidth(PresetPrimaryActions::LayoutMode::library)));
    auto compareActions = browserArea.removeFromTop(34).withTrimmedTop(1);
    components.compareActions.setBounds(compareActions.removeFromLeft(PresetCompareActions::preferredWidth));
