...
- The editor now installs laptop-key audition listeners across the component tree while skipping text-entry/combo-box focus, and hidden analyzer/wave/sample/sequence/MOD visual refresh work is gated in the timer to reduce off-page UI churn.
