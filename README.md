...
- Synth engine: oscillator 1, oscillator 2, sub, noise colors with percussive decay, internal wavetable mode with Osc 1/Osc 2 WT position controls, Osc Warp source shaping, unison/spread, envelopes, multimode filter with a live response display, Filter Character and Slope modes, drive, editable modulation with per-route bypass/delete, activity-metered LFO 1/LFO 2/Mod Env/Velocity/S&H/Smooth/Chaos movement sources, and eight stable performance macros for club-ready tone, dirt, motion, space, weight, bounce, warp, and throw moves. Saw, square, triangle, and wavetable sources include a first bandlimited/procedural quality pass for cleaner bright stabs and bass harmonics.
...
The repo-managed factory pack currently includes 24 starter presets across UKG, house, tech-house, minimal, and techno.
